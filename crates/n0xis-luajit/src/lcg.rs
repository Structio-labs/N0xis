...
//!
//! Some engines (the Bitsquid-bundle engine family's `Math.next_random` among
//! them) derive a deterministic sequence from a small integer seed with a textbook LCG:
