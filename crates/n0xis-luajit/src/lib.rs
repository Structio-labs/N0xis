...
mod tests {
    ...
    /// Bitsquid-bundle GC64 layout, surrounded by unrelated filler bytes so the
    ...
    fn finds_a_known_gcstr_at_the_expected_object_base() {
        ...
        let hits = scan_strings(&snap, &[(base, 0x1000)], GcstrLayout::BITSQUID_GC64, 1, 16);
        ...
        assert_eq!(hit.object_base, base.offset(needle_off as u64 - GcstrLayout::BITSQUID_GC64.len_offset));
    ...
    fn min_max_len_bounds_are_enforced() {
        ...
        let hits = scan_strings(&snap, &[(base, 0x1000)], GcstrLayout::BITSQUID_GC64, 1, 3);
