...
static FINGERPRINTS: &[Fingerprint] = &[
    ...
    Fingerprint { value: 1664525, width: 32, algorithm: "LCG", role: "multiplier a", formula: Some("s' = s*1664525 + 1013904223 (mod 2^32)"), note: Some("Numerical Recipes — observed live in a Bitsquid-bundle game's combo RNG — pairs with c=1013904223") },
