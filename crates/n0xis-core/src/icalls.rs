...
//! `il2cpp icalls` — recover the engine's internal-call table from the code
...
//!
//! What the emitted code does instead, measured on a real IL2CPP build:
//!
//! ```text
...
//!
//! Measured across three IL2CPP builds (metadata v24, v29, v31): the shape holds
...
//!
//! The name test (`Namespace.Type::Method`) is a fact of the runtime and holds anywhere.
...
//! ARM64 IL2CPP build (Android, iOS). Such a target still gets its icall names
