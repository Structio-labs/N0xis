...
//! `decomp pseudo` names 0 of 69 calls on an IL2CPP build. This crate is the
...
//!
//! ## Address spaces are explicit, and that is the whole IL2CPP-WebGL story
//!
//! IL2CPP WebGL builds go through the **same IL2CPP pipeline** as Windows ones:
...
//! — which finally yields the wasm function index. (IL2CPP WebGL dispatches
...
pub enum AddressSpace {
    ...
    /// An IL2CPP WebGL dump. Its numbers are **not addresses**: each is an offset
